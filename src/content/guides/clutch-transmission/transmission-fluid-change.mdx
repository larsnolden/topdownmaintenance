...
- Manual transmission fluid meeting NB manual spec (commonly GL-4 class for synchronized manual boxes)
...
Confirm you can remove the fill plug before opening the drain plug.
