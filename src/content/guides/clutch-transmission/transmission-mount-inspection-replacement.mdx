...
> Community quote: NB owners regularly report drivetrain knock/vibration tied to mount wear and note that correct alignment during reassembly is critical for noise reduction. https://duckduckgo.com/html/?q=site:mx5nutz.com+NB+transmission+mount
...
> Community confirmation quote: r/Miata discussions repeatedly indicate that mount-related NVH is often misdiagnosed as gearbox failure; symptom-based verification after mount service is important. https://www.reddit.com/r/Miata/search/?q=NB%20transmission%20mount&restrict_sr=1
...
- Several direct mount-replacement how-to pages were unavailable/geo-blocked in this run.
- Process confidence is high; exact variant torque and mount-style details are deferred to year/VIN FSM.

## Image Credits

No clearly reusable licensed NB-specific transmission mount layout diagrams were obtained during this run.
...
4. DuckDuckGo — *site:mx5nutz.com NB transmission mount* (index of NB mount threads). Retrieved 2026-03-12. https://duckduckgo.com/html/?q=site:mx5nutz.com+NB+transmission+mount
5. Reddit (r/Miata) — *Search results for NB transmission mount*. Retrieved 2026-03-12. https://www.reddit.com/r/Miata/search/?q=NB%20transmission%20mount&restrict_sr=1
