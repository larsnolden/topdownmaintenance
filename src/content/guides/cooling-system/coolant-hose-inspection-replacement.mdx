...
- NB1/NB2-compatible molded coolant hoses (radiator upper/lower + heater/feed-return as applicable)
...
1. Upper radiator hose (thermostat housing to radiator top)
2. Lower radiator hose (engine/radiator lower connection)
3. Heater core feed hose
4. Heater core return hose
5. Overflow bottle hose (if brittle)

If your goal is a full age-refresh, include smaller bypass/heater-adjacent hoses as well.
