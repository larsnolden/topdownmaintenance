...
On NB cars, the factory airbox is the black plastic box on the intake side of the engine bay, connected to the intake tube/MAF path. Release the retaining clips and lift the lid enough to remove the panel element.

Before removing the old filter, note which side faces up and how the perimeter gasket sits in the airbox groove.
...
7. CarCareKiosk — *How to Change Engine Air Filter: 2001 Mazda Miata LS 1.8L 4 Cyl.* Retrieved 2026-02-28. https://www.carcarekiosk.com/video/2001_Mazda_Miata_LS_1.8L_4_Cyl./air_filter_engine/replace
