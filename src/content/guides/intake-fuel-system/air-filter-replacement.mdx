...
- Follow your market/year owner’s manual maintenance schedule for replacement interval.
- If driving in dusty or leaf-heavy environments, inspect earlier and replace based on restriction/contamination.
- Reusable/oiled media can extend service life only when cleaned and oiled exactly to manufacturer procedure.
