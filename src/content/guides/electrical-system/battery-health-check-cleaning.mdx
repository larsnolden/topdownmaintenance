...
1. MELLENS — Mazda Miata factory service manual archive (year-specific NB electrical system reference index). Retrieved 2026-03-12. https://www.mellens.net/mazda/
2. 2CarPros — Battery/connection diagnostic workflow and practical cranking-behavior checks. Retrieved 2026-03-12. https://www.2carpros.com/articles/everything-goes-dead-when-engine-is-cranked
3. Interstate Batteries — Battery terminal corrosion cleaning method (baking soda/water and post-cleaning practice). Retrieved 2026-03-12. https://www.interstatebatteries.com/blog/how-to-clean-battery-corrosion
